...
export const AnimatedCharacters: React.FC<AnimatedCharactersProps> = ({
  ...
  return (
    <div
      ref={containerRef}
      id="characters-stage"
      className="relative w-full h-full min-h-[160px] sm:min-h-[240px] md:min-h-[540px] bg-[#eceef1] flex items-end justify-center p-2 sm:p-6 md:p-8 select-none overflow-hidden"
    >
      ...
      {/* SVG Stage container */}
      <div className="relative w-full max-w-[190px] sm:max-w-[270px] md:max-w-[340px] h-[155px] sm:h-[230px] md:h-[330px] flex items-end justify-center">
        <svg
          viewBox="0 0 340 330"
