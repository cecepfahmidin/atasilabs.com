...
export function SectionHeader({
  ...
  subtitleWidth = 'w-full max-w-[700px]',
}: SectionHeaderProps) {
  return (
    <div className="flex flex-col gap-[16px] w-full">
      ...
      <h2
        className={`font-grotesk text-[32px] md:text-[52px] font-bold text-[#F5F5F0] tracking-[-1px] leading-[1.08] whitespace-pre-line ${titleWidth}`}
      >
